...
Get world-class AI outputs, every single time.

## What It Does

Forces AI to think like a world-class expert before giving you anything:
- Define excellence standards first
- Create a scoring rubric
- Self-evaluate and find blind spots
- Iterate to perfection
- Show you the entire thinking process

## Features

- Pre-loaded templates for common tasks
- One-click copy to clipboard
- Custom prompt generation
- Templates for: Website Design, Email Campaigns, Competitor Analysis, Content Strategy, Brand Messaging, Brand Guidelines
...
4. Add context (who it's for, what the goal is)
5. Click "Generate World-Class Prompt"
6. Copy and paste into Claude or your AI tool of choice
